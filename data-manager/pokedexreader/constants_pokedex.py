...
GEN2_DEX = GEN1_DEX + ["chikorita", "bayleef", "meganium", "cyndaquil", "quilava",
            ...
            "lanturn", "pichu", "pichuspikyeared", "cleffa",
...
GEN3_DEX = GEN2_DEX + ["treecko", "grovyle", "sceptile", "torchic", "combusken",
            ...
            "milotic", "castform", "castformsunny", "castformrainy",
            "castformsnowy", "kecleon", "shuppet", "banette",
...
GEN4_DEX = GEN3_DEX + ["deoxys", "deoxysattack", "deoxysdefense",
            ...
            "cherrimsunshine", "shellos", "gastrodon", "ambipom",
...
GEN5_DEX = GEN4_DEX + ["victini", "snivy", "servine", "serperior", "tepig",
            ...
            "terrakion", "virizion", "tornadus", "tornadustherian",
            "thundurus", "thundurustherian", "reshiram", "zekrom",
            "landorus", "landorustherian", "kyurem", "kyuremblack",
            "kyuremwhite", "keldeo", "keldeoresolute", "meloetta",
            "meloettapirouette", "genesect", "genesectdouse",
...
GEN6_DEX = GEN5_DEX + ["chespin", "quilladin", "chesnaught", "fennekin", "braixen",
            ...
            "scatterbug", "spewpa", "vivillon", "vivillonfancy",
            "vivillonpokeball", "litleo", "pyroar", "flabebe", "floette",
            "floetteeternal", "florges", "skiddo", "gogoat", "pancham",
            "pangoro", "furfrou", "espurr", "meowstic", "meowsticf", "honedge",
            "doublade", "aegislash", "aegislashblade", "spritzee",
            ...
            "zygarde", "zygarde10", "zygardecomplete", "diancie",
            "dianciemega", "hoopa", "hoopaunbound", "volcanion"]
GEN7_DEX = GEN6_DEX + ORAS_MEGAS + ["rowlet", "dartrix", "decidueye", "litten",
            ...
            "lycanrocdusk", "wishiwashi", "wishiwashischool", "mareanie",
            ...
            "miniormeteor", "komala", "turtonator", "togedemaru", "mimikyu",
            "mimikyubusted", "bruxish", "drampa", "dhelmise", "jangmoo",
            ...
            "guzzlord", "necrozma", "necrozmaduskmane", "necrozmadawnwings",
            "necrozmaultra", "magearna", "magearnaoriginal", "marshadow"]
...
available_pokemon = {
    ...
    "sun-moon": GEN7_DEX,
    "ultra-sun-ultra-moon": GEN7_DEX + ["poipole", "naganadel", "stakataka",
                             "blacephalon", "zeraora"]
}
